...
class EditStoreFragment : Fragment() {
        ...
        return when(item.itemId) {
            ...
            R.id.action_save -> {
                if (mStoreEntity != null &&
                    ...
                    doAsync {
                        if (mIsEditMode) StoreApplication.database.storeDao().updateStore(mStoreEntity!!) //actualizar
                        else mStoreEntity!!.id = StoreApplication.database.storeDao().addStore(mStoreEntity!!)//almacenar nuevo dato
                        uiThread {
                            hideKeyboard()
                            if (mIsEditMode){
    ...
    private fun validateFields(): Boolean {
        ...
        val isEmptyPhotoUrl = mBinding.etPhotoUrl.text.toString().trim().isEmpty()
        val isEmptyPhone = mBinding.etPhone.text.toString().trim().isEmpty()
        val isEmptyName = mBinding.etName.text.toString().trim().isEmpty()
